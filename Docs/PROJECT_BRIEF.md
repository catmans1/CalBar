...
See `preview.html` (project root) for exact UI styling, including translucent dark-mode glassmorphism (`.ultraThinMaterial`), layout padding, and color schemes.
See `preview-settings.html` (project root) for the Settings window layout.
